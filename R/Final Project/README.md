...
### Матриця кореляцій
<img src="ReadmeResources/Correlation matrix.png" alt="Матриця кореляцій візуалізована з ggplot2" width="64%" height="auto">

### Розподіл якості сну
<img src="ReadmeResources/SleepQuality.png" alt="Розподіл якості сну візуалізований з ggplot2" width="64%" height="auto">

### Вплив віку на якість сну
<img src="ReadmeResources/Age&SleepQuality.png" alt="Вплив віку на якість сну візуалізований з ggplot2" width="64%" height="auto">

### Вплив довжини сну на якість сну
<img src="ReadmeResources/SleepDuration&SleepQuality.png" alt="Вплив довжини сну на якість сну візуалізований з ggplot2" width="64%" height="auto">

### Вплив рівню стресу на якість сну
<img src="ReadmeResources/StressLevel&SleepQuality.png" alt="Вплив рівню стресу на якість сну візуалізований з ggplot2" width="64%" height="auto">

### Вплив швидкості серцебиття на якість сну
<img src="ReadmeResources/HeartRate&SleepQuality.png" alt="Вплив серцебиття на якість сну візуалізований з ggplot2" width="64%" height="auto">

### Вплив фізичної активності на якість сну
<img src="ReadmeResources/PhysicalActivity&SleepQuality.png" alt="Вплив фізичної активності на якість сну візуалізований з ggplot2" width="64%" height="auto">

### Вплив професії на якість сну
<img src="ReadmeResources/Occupation&SleepQuality.png" alt="Вплив ghjatcs] на якість сну візуалізований з ggplot2" width="64%" height="auto">
